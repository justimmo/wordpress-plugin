<div id="ji_sideBar">
    ...
    <form action="<?php echo $ji_api_wp_plugin->getIndexUrl() ?>" method="get">
        ...
        <div class="bg_formRow">
            ...
            <div class="bg_formInput">
                <select id="ji_searchbar_states" name="filter[bundesland_id]">
                    <option value=""></option>
                    <option value="AT" <?php echo isset($ji_obj_list->filter['bundesland_id']) && $ji_obj_list->filter['bundesland_id'] == 'AT' ? 'selected=selected' : '' ?>>
                        Österreich
                    </option>
                    <?php foreach ($ji_api_wp_plugin->getClient()->getBundeslaender()->bundesland as $bundesland): ?>
                        <option value="<?php echo $bundesland->id ?>" <?php echo isset($ji_obj_list->filter['bundesland_id']) && $ji_obj_list->filter['bundesland_id'] == $bundesland->id ? 'selected=selected' : '' ?>>
                            &nbsp;&nbsp;<?php echo $bundesland->name ?></option>
                    <?php endforeach; ?>
                    <option value="FOREIGN" <?php echo isset($ji_obj_list->filter['bundesland_id']) && $ji_obj_list->filter['bundesland_id'] == 'FOREIGN' ? 'selected=selected' : '' ?>>
                        Ausland
                    </option>
                </select>
            </div>
